---
source_url: https://docs.typesafe.ai/models.md
fetched_at: 2026-09-21
local_path: models.md
---
...
- **`models`** `array` *(required)* — One entry per model or alias.

  
  <details>
  <summary><strong>properties</strong></summary>

- **`name`** `string` *(required)* — The model ID or alias, as accepted by the `model` field.
