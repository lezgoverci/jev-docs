---
source_url: https://docs.typesafe.ai/primitives.md
fetched_at: 2026-09-21
local_path: primitives.md
---
...
## Next steps
  ...
  - [**Choice**](./primitives/choice.md) — Pick one option from a fixed list.


  - [**Score**](./primitives/score.md) — Rate the state along ordered levels.


  - [**Noul**](./primitives/noul.md) — Get the probability that a statement is true.
